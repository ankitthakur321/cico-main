                                                ...
                                                <div>
                                                    ...
                                                    <div class="facility-icon">
                                                        <div class="facility-box">
                                                            <img src="<?=base_url('assets/images/icon/hotel/beer.png')?>"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                            <span>bar</span>
                                                        </div>
                                                        <div class="facility-box">
                                                        ...
                                                        <div class="facility-box">
                                                            <img src="<?=base_url('assets/images/icon/hotel/sunset.png')?>"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                            <span>beach</span>
                                                        </div>
                                                        <div class="facility-box">
                                                            <img src="<?=base_url('assets/images/icon/hotel/pool.png')?>"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                            <span>swimming</span>
                                                        </div>
                                                    </div>
