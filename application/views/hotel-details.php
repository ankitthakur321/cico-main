            ...
            <div class="row">
                <div class="col-12">
                    <div class="hotel_title_section">
                        <div class="hotel-name">
                            <div class="left-part">
                                <div class="top">
                                    <h2><?=$hoteldetail[0]['hotel_name']?></h2>
                                    <div class="rating">
                                        <?php   $hotelRating = $hoteldetail[0]['rating'];  
                                                $i=0;
                                                while($i<5)
                                                {
                                                    if($i < $hotelRating)
                                    ...
                                    <div class="share-buttons">
                                        <button type="button" class="btn btn-solid" id="ShareButton"><i class="far fa-share-square"></i> share</button>
                                         <?php if($this->session->userdata('loggedIn')) { ?>
								           <?php if($inCart($hoteldetail[0]['hotel_id']))
								                 { 
								           ?>
    									            <a disabled class="btn btn-solid text-dark"><i class="fas fa-shopping-cart text-danger"></i>&nbsp;Added to Cart</a>
								           <?php 
								                 }
								                 else
								                 {
								           ?>
								                    <a href="<?=base_url('hotels/addToCart/').$hoteldetail[0]['hotel_id']?>" class="btn btn-solid">
                                ...
                                <div class="facility-detail">
                                    <span>free wifi</span>
                                    <?php if($hotelRooms[0]['isBreakfast']=='1') echo "<span>free breakfast</span>"; ?>
                                    <?php if($hoteldetail[0]['unmarried_couples']=='Allowed') echo "<span>Couple Friendly</span>"; ?>
                                    <span><?=$hoteldetail[0]['free_cancellation']?> Free Cancellation</span>
                                </div>
                            </div>
                            <div class="right-part">
                                <h2 class="price">₹ <?=$hotelRooms[0]['double_room_price']?><span>/ per night</span></h2>
                                <!--<a href="<?=base_url('users/hotelbooking/'.$hoteldetail[0]['hotel_id'])?>" class="btn btn-rounded btn-sm color1">book this now</a>-->
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="slide-1 arrow-dark zoom-gallery ratio2_3">
                                    <div>
                                        <a href="<?=base_url($hoteldetail['0']['hotel_image'])?>">
                                            <img src="<?=base_url($hoteldetail['0']['hotel_image'])?>" class="img-fluid blur-up lazyload bg-img w-100" alt="Hotel Image">
                                            <h6 class="view-all">Hotel Image</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 ratio_59">
                                        <div class="slide-1 zoom-gallery no-arrow">
                                            <?php
                                                foreach($hotelRooms as $hRoomImage)
                                                {
                                            ?>
                                                    <div>
                                                        <a href="<?=base_url($hRoomImage['room_image'])?>">
                                                            <img src="<?=base_url($hRoomImage['room_image'])?>"
                                                                class="img-fluid blur-up lazyload bg-img w-100" alt="Hotel Rooms Image">
                                        ...
                                        <div class="slide-1 zoom-gallery no-arrow m-cls">
                                            <?php
                                                foreach($hotelGallery as $hGallery)
                                                {
                                            ?>
                                                    <div>
                                                        <a href="<?=base_url($hGallery['url'])?>">
                                                            <img src="<?=base_url($hGallery['url'])?>"
                                                                class="img-fluid blur-up lazyload bg-img w-100" alt="Hotels Gallery">
                                                            <h6 class="view-all">view hotel gallery</h6>
                                                        </a>
                                                    </div>
                                            <?php
                                                }
                    ...
                    <div class="description-section tab-section">
                        <div class="menu-top">
                            <ul class="nav nav-tabs" id="top-tab" role="tablist">
                                <li class="nav-item"><a data-bs-toggle="tab" class="nav-link active" href="#rooms">rooms</a></li>
                            ...
                            <div class="description-details tab-content" id="top-tabContent">
                                <div class="menu-part tab-pane fade show active px-5 py-5" id="rooms">
                                    <table class="rooms-box">
                                        <?php
                                            foreach($hotelRooms as $hRoom)
                                            {
                                        ?>
                                        <tr class="mb-4">
                                            <td>
                                                <h6 class="room-title"><?=strtolower($hRoom['room_title'])?> Room</h6>
                                                <div class="slide-1 arrow-dark zoom-gallery ratio2_3">
                                                    <div>
                                                        <a href="<?=base_url($hRoom['room_image'])?>">
                                                            <img src="<?=base_url($hRoom['room_image'])?>"
                                                                class="img-fluid blur-up lazyload" alt="Hotel Room Image">
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div class="room-detail">
                                                    <div class="row">
                                                        <div class="col-6 p-0">
                                                            ...
                                                            <div class="facility-detail">
                                                                <ul>
                                                                    <li><img src="<?=base_url('assets/images/icon/tour/bed.png')?>"
                                                                            class="img-fluid blur-up lazyload" alt="">
                                                                        king/twin
                                                                    </li>
                                                                    <li><img src="<?=base_url('assets/images/icon/hotel/shower.png')?>"
                                                                            class="img-fluid blur-up lazyload" alt="">
                                                                        Shower
                                                                    </li>
                                                                    <li><img src="<?=base_url('assets/images/icon/hotel/television.png')?>"
                                                                            class="img-fluid blur-up lazyload" alt="">
                                                                        LCD TV</li>
                                                                    <li><img src="<?=base_url('assets/images/icon/hotel/couch.png')?>"
                                                                            class="img-fluid blur-up lazyload" alt="">
                                                                        couch
                                                                    </li>
                                                                </ul>
                                            ...
                                            <td>
                                                <div class="price-details">
                                                    <div>
                                                        <h6><del>₹ <?=ceil($hRoom['double_room_price']*1.2)?></del></h6>
                                                        <h5>₹ <?=$hRoom['double_room_price']?></h5>
                                                        <span>per night</span>
                                                        <input type="hidden" id="roomId<?=$hRoom['room_id']?>" name="roomId<?=$hRoom['room_id']?>" value="<?=$hRoom['room_id']?>" >
                                                        <button type="button" class="btn btn-rounded btn-sm color1" id="selectroom<?=$hRoom['room_id']?>">Select Room</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <script>
                                        let roomType<?=$hRoom['room_id']?> = document.getElementById("selectroom<?=$hRoom['room_id']?>");
                                            roomType<?=$hRoom['room_id']?>.addEventListener('click',function(){
                                                
                                                var rId = <?=$hRoom['room_id']?>;
                                                if(rId!=''){
                                                    $.ajax({
                                                    type: "POST",
                                                    url: "<?=base_url('hotels/getRoomPrice')?>",
                                                    dataType: 'json',
                                                    data: {rmId: rId},
                                                    success: function(res) {
                                                        if(res.roomPrice!='')
                                                        {
                                                            ...
                                                            $('#rPrice1').html("₹ " + Math.ceil(res.roomPrice*1.5));
                                                            $('#bookingRoomType').val(res.roomID);
                                ...
                                <!--<div class="about menu-part tab-pane fade" id="about"></div>-->
                                <div class="menu-part tab-pane fade facility" id="facility">
                                    <div class="row">
                                                ...
                                                <div class="col-xl-4 col-6">
                                                    <ul>
                                                        <li><i class="fas fa-check"></i> <?=$amenity['amenities'] ?></li>
                                                    </ul>
                                                </div>
                                                <?php
                                                    }
                                ...
                                <div class="menu-part tab-pane fade map" id="location">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115133.01016842092!2d85.0730025389232!3d25.608020764526835!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f29937c52d4f05%3A0x831a0e05f607b270!2sPatna%2C%20Bihar!5e0!3m2!1sen!2sin!4v1650212924098!5m2!1sen!2sin" style="border:0;" allowfullscreen="" ></iframe>
                                </div>
                                <!--review start-->
                ...
                <div class="col-xl-3 col-lg-4" id="booking">
                    <div class="single-sidebar">
                        <div class="selection-section">
                            <div class="price-part">
                                <div class="left-part">
                                    <a href="javascript:;" id="roomsType"><?=ucfirst(strtolower($hotelRooms[0]['room_title']))?> Rate</a>
                                    <span class="mt-2"><i class="fas fa-check"></i> Room only</span>
                                    <span><i class="fas fa-check"></i> free wifi</span>
                                </div>
                                <div class="right-part">
                                    <span>per night</span>
                                    <p class="mt-0" id="rPrice1"><del>₹ <?php $pr1 = $this->session->userdata('bookingPrice')?$this->session->userdata('bookingPrice'):$this->session->userdata('guests')?ceil($this->session->userdata('guests')/2):1; echo ceil($pr1*$hotelRooms[0]['double_room_price']*1.2); ?></del></p>
                                    <h6 id="rPrice">₹ <?php $pr1 = $this->session->userdata('bookingPrice')?$this->session->userdata('bookingPrice'):$this->session->userdata('guests')?ceil($this->session->userdata('guests')/2):1; echo $pr1*$hotelRooms[0]['double_room_price']?></h6>
                                </div>
                            </div>
                            <div class="book-btn-section">
                                <form method="POST" action="<?=base_url('hotels/bookingdetails/'.$hoteldetail[0]['hotel_id'])?>">
                                    <input type="hidden" id="bookingPriceInitial" name="bookingPriceInitial" value="<?=$hotelRooms[0]['double_room_price']?>" required />
                                    <input type="hidden" id="bookingPrice" name="bookingPrice" value="<?php $pr1 = $this->session->userdata('bookingPrice')?$this->session->userdata('bookingPrice'):$this->session->userdata('guests')?ceil($this->session->userdata('guests')/2):1; echo $pr1*$hotelRooms[0]['double_room_price']?>" required />
                                    <input type="hidden" name="percentageAgreed" value="<?=$hoteldetail[0]['percentage_agreed']?>" required />
                                    <input placeholder="CheckIn Date" id="datepicker2" class="form-control bg-transparent mb-2" placeholder="Choose CheckIn Date" name="bookingCheckInDate" value="<?php if($this->session->userdata('checkInDate')) { echo $this->session->userdata('checkInDate'); }?>" autocomplete="off" required />
                                    <input placeholder="CheckOut Date" id="datepicker3" class="form-control bg-transparent mb-2" placeholder="Choose CheckOut Date" name="bookingCheckOutDate" value="<?php if($this->session->userdata('checkOutDate')) { echo $this->session->userdata('checkOutDate'); }?>" autocomplete="off" required />
                                     <div id="timeDiv" <?php if($this->session->userdata('bookingStayType')){ if($this->session->userdata('bookingStayType')=="6 Hours Stay" || $this->session->userdata('bookingStayType')=="3 Hours Stay"){ echo "style='display:block;'"; } else { echo "style='display:none;'"; } } else { echo "style='display:none;'"; } ?> >
                                        <input placeholder="CheckIn Time" id="timepicker1" class="form-control bg-transparent mb-2" name="bookingCheckInTime" value="<?=$this->session->userdata('bookingCheckInTime')?>" autocomplete="off" />
                                        <input placeholder="CheckOut Time" id="timepicker2" class="form-control bg-transparent mb-2" name="bookingCheckOutTime" value="<?=$this->session->userdata('bookingCheckOutTime')?>" autocomplete="off" />
                                    </div>
                                    <div class="selector mb-2">
                                        <select id="bookingStayType" name="bookingStayType" required>
                                            <option value="" disabled selected>Stay Type</option>
                                            <option value="3 Hours Stay" <?php if($this->session->userdata('checkInDate')=="3 Hours Stay") { echo "selected"; } ?> >3 Hours</option>
                                            <option value="6 Hours Stay" <?php if($this->session->userdata('checkInDate')=="6 Hours Stay") { echo "selected"; } ?>>6 Hours</option>
                                            <option value="Fixed Stay" <?php if($this->session->userdata('checkInDate')=="Fixed Stay") { echo "selected"; } else {echo "selected"; } ?> >Fixed Stay</option>
                                        </select>
                                    </div>
                                    <div class="rooms-section">
                                        <input type="text" class="form-control open-select bg-transparent" placeholder="rooms & guests" id="totalGuests" name="totalGuests" value="<?=$this->session->userdata('bookedRooms')?$this->session->userdata('bookedRooms'):$this->session->userdata('guests')?ceil($this->session->userdata('guests')/2):1?> Room, <?=$this->session->userdata('guests')?$this->session->userdata('guests'):1?> Guest" readonly>
                                        <div class="selector-box">
                                            <div class="room-cls">
                                                <div class="qty-box">
                                                    <label>guests</label>
                                                    <div class="input-group">
                                                        <button type="button" class="btn" id="guestRemove"> - </button>
                                                        <input type="number" class="form-control bg-transparent" id="bookedGuests" name="guests" readonly value="<?=$this->session->userdata('guests')?$this->session->userdata('guests'):1?>" required>
                                                        <button type="button" class="btn" id="guestAdd">+</button>
                                                    </div>
                                                </div>
                                                <div class="qty-box">
                                                <label>rooms</label>
                                                <div class="input-group">
                                                    <button type="button" class="btn" id="roomRemove"> - </button>
                                                    <input type="number" name="quantity" class="form-control bg-transparent" id="bookedRooms" readonly value="<?=$this->session->userdata('bookedRooms')?$this->session->userdata('bookedRooms'):$this->session->userdata('guests')?ceil($this->session->userdata('guests')/2):1?>" required>
                                                    <button type="button" class="btn" id="roomAdd"> + </button>
                                                </div>
                                            </div>
                                            </div>
                                            <div class="bottom-part">
                                                <button type="button" class="btn" id="applyBtn" data-dismiss="selector-box">apply</button>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="bookingGuests" id="bookingGuests" value="<?=$this->session->userdata('guests')?$this->session->userdata('guests'):1?>" required />
                                    <input type="hidden" name="bookingRooms" id="bookingRooms" value="<?=$this->session->userdata('bookedRooms')?$this->session->userdata('bookedRooms'):$this->session->userdata('guests')?ceil($this->session->userdata('guests')/2):1?>" required />
                                    <div class="selector">
                                        <select id="bookingRoomType" name="bookingRoomType" required>
                                            <option value="" disabled>Room Type</option>
                                            <?php
                                                foreach($hotelRooms as $i => $hRoom)
                                                {
                                            ?>
                                                    <option value="<?=$hRoom['room_id']?>" <?php if($i==0){ echo "selected"; } ?> ><?=$hRoom['room_title']?></option>
                                            <?php  }  ?>
                                        </select>
                                    </div>
                                    <button type="submit" class="btn btn-rounded btn-sm color1">book this now</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="single-sidebar">
                        ...
                        <p class="address"> <i class="fas fa-map-marker-alt"></i><?=$hoteldetail[0]['hotel_location'].", ".$hoteldetail[0]['state'].", ".$hoteldetail[0]['country']?></p>
                        <p><i class="fas fa-phone-alt"></i> +91 9153 9001 80</p>
                        <a href="#">
                            <p><i class="fas fa-envelope"></i><a href="mailto:support@checkinandcheckout.com" class="text-muted">support@checkinandcheckout.com</a></p>
                        </a>
                    </div>
                    <div class="single-sidebar">
...
{
    echo "<script>window.location.href='".base_url('hotels/hotelslist')."';</script>";
}
?>
...
<script src="<?= base_url('assets/js/hotel-details-custom-js.js')?>"></script>
<script>
    $(document).ready(function () {
        $(document).on("click", "#ShareButton", function (e) {
            ...
            alert('Link Copied. You can share it anywhere you want.');
            $("#copyURL").remove();            
        });
    });
</script>    
